...
| [0009](/.agents/decisions/0009-tm-heartbeat-passive-liveness.md) | The `tm` heartbeat is passive dispatcher-side liveness observation, not a teammate-push heartbeat | Accepted |
